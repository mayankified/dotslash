...
const appointments = [
  { doctor: 'Dr. Mayank Kashyap', specialty: 'Cardiologist', date: 'Tomorrow, 10:00 AM' },
  { doctor: 'Dr. Shreya Sharma', specialty: 'Neurologist', date: 'Friday, 2:30 PM' },
];
  ...
  return (
    <div className="w-full mx-auto p-6 max-w-screen-lg">
      ...
      <header className="flex justify-between items-center mb-8">
        ...
        <div>
          <h1 className="text-4xl font-bold tracking-tight">Welcome back, Buddy!</h1>
        ...
        {/* <Button className="gap-2 bg-blue-500 hover:bg-blue-600 text-white">
         ...
         {/* New Buttons Below Appointment Card */}
         <div className="flex flex-col justify-center gap-2 mt-8">
            ...
            <Link to="/report">
              <Button className="bg-green-500 text-white px-6 py-3 rounded-lg flex items-center gap-2">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="bg-gray-100 p-2 rounded-lg">
          <TabsTrigger value="overview" className="px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">
            Overview
          </TabsTrigger>
          <TabsTrigger value="fact" className="px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">
            Awareness
          </TabsTrigger>
          <TabsTrigger value="diet" className="px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">
            Diet Planner
          </TabsTrigger>
        </TabsList>
                      ...
                      <TooltipTrigger>
                        {key === 'heartRate' ? <Heart className="h-5 w-5 text-red-500" /> :
                          key === 'bloodPressure' ? <Activity className="h-5 w-5 text-blue-500" /> :
                            key === 'spO2' ? <Stethoscope className="h-5 w-5 text-green-500" /> :
              ...
              <Card className="shadow-md">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { label: 'Disease Detection', icon: <Stethoscope className="h-6 w-6" />, path: '/disease-detection' },
                      { label: 'Chat Assistant', icon: <Bot className="h-6 w-6" />, path: '/chatbot' },
                      { label: 'Hospital Beds', icon: <Hospital className="h-6 w-6" />, path: '/hospital-beds' },
                      { label: 'Blood Donors', icon: <Droplet className="h-6 w-6" />, path: '/blood-donor' }
